...
cd 
cd $BIN_PATH_1/kernel/lib/
if [ $MODEL -eq "002" ]
then
if [ -e $BIN_PATH_1/kernel/lib/drv_ak39xx.a ]
then
mv drv_ak39xx.a drv_ak39xx_old.a
fi
fi

cd 
cd $BIN_PATH_1/kernel/include/driver/
if [ $MODEL -eq "002" ]
then
if [ -e $BIN_PATH_1/kernel/include/driver/drv_api.h ]
then
sed -i '26s/#define _DRV_LIB_VER    "DrvLib V1.20.03"/#define _DRV_LIB_VER    "DrvLib V1.20.03_100nfvcm2"/g' drv_api.h
fi
fi
...
cd
cd $MAIN_PATH
cp -r drv_ak39xx.a /$BIN_PATH_1/kernel/lib/
